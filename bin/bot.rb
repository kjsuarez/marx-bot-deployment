...
ADJECTIVE_PATH = File.join(File.dirname(__FILE__), "library/adjective.json")
ADJECTIVE_DICT = JSON.parse(File.read(ADJECTIVE_PATH))

NOUN_PATH = File.join(File.dirname(__FILE__), "library/noun.json")
NOUN_DICT = JSON.parse(File.read(NOUN_PATH))

SLOGAN_PATH = File.join(File.dirname(__FILE__), "library/slogans.json")
